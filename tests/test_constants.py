...
def test_str_to_color():
    ...
    assert constants.str_to_color("+") == constants.BOOST_POS
    assert constants.str_to_color("-") == constants.BOOST_NEG
...
def test_color_to_str():
    ...
    assert constants.color_to_str(constants.BOOST_POS) == "+"
    assert constants.color_to_str(constants.BOOST_NEG) == "-"
